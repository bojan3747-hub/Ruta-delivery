...
async function main() {
  ...
  const standardna = await createShipment({
    ...
    posiljalacIme: "Ana Jovanović",
    posiljalacTelefon: "+381601111111",
    primalacIme: "Marko Petrović",
    primalacTelefon: "+381602222222",
    tip: "SREDNJI_PAKET",
  ...
  await createShipment({
    ...
    posiljalacIme: "Jovana Simić",
    posiljalacTelefon: "+381603333333",
    primalacIme: "Nikola Ilić",
    primalacTelefon: "+381604444444",
    tip: "VELIKI_PAKET",
    sadrzajPosiljke: "POLJOPRIVREDA_I_OPREMA",
